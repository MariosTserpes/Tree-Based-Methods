...
\begin{figure}[H]
                ...
                \end{figure}
Επίσης, παρατηρούμε ότι το πλήθος των καταληκτικών κόμβων είναι \textbf{18}, ενώ οι πιο σημαντικές παράγοντες στην εκτίμηση της εξαρτημένης μεταβλητές αποτελούν η θέση που τα παιδικά καθίσματα διατίθενται στα ράφια καθώς και οι τιμή τους.  
\newline
...
\begin{enumerate}
    \item  \textbf{Εάν \en (Shelveloc = Bad or Medium) \& (Price $<$ 94.5) \& (Age $<$ 39.5) \el τότε $\approx$ 11.640}
    \newline \el 
    Αν η απάντηση είναι καταφατική, δηλαδή τα καθίσματα βρίσκονται σε κακής ή μέτριας ποιότητας θέσης στο ράφι και η τιμή που τα χρεώνει η εταιρεία  είναι χαμηλότερη των 94.5 μονάδω και η μέση ηλικία του τοπικού πληθυσμού είναι μικρότερη των 39.5 ετών, τότε εκτιμάται ότι οι πωλήσεις των καθισμάτων για καταστήματα που έχουν τα ανωτέρω χαρακτηριστικά θα είναι \textbf{11.640} παιδικά καθίσματα.
\end{enumerate}
